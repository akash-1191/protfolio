  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block  md:w-auto" id="navbar-solid-bg">
      <ul class="flex flex-col font-medium  rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent md:dark:bg-transparent">
        ...
        <li>
          <a href="https://github.com/akash-1191" target="_blank" class=" px-3 md:p-0 text-white text-xl">
            <button class=" btn-grad border flex justify-center items-center gap-2 border-red-500 p-2 -mt-1   rounded-md bg-red-500 hover:bg-red-600">
              <svg width="25" height="25" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
