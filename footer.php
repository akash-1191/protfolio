<footer class="bg-black body-font">
    <div class="container px-5 py-5 text-center mx-auto grid md:grid-cols-3 sm:grid-cols-1  sm:text-center ">
        <div class="flex justify-center items-center">
            <p class="ml-3 text-xl  text-white font-bold capitalize">Designed and Developed by Akash Maurya</p>
        </div>
        <div class="ml-10">
            <p class="text-lg text-white font-semibold sm:ml-4 sm:pl-4 sm:border-l-2 sm:py-2 sm:mt-0 mt-4">
                Copyrite &copy; 2024 [ AM ]
            </p>
        </div>
